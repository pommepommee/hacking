...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/mnt/hgfs/RootMe/Reseau/capture.raw', True, 0, 0)
        ...
        self.connect((self.blocks_file_source_0, 0), (self.analog_fm_demod_cf_0, 0))
